    ...
    <font size="5">  
     <a href="../index.php">Logout</a> |
         ...
         <td align="center" bgcolor="green"><h2> 
          ...
          <td><li class="active"><a href="prisonerep.php"><button>Inmates Report</button></a></li></td>
          ...
          <td><li><a href="Officerrep.php"><button>Warder Report</button></a></li></td>
          <td><li><a href="newprisonrep.php"><button>New Prison Report</button></a></li></td>
          <td><li><a href="Officereport.php"><button>Warder details Report</button></a></li></td>
        </ul>
      </div>
    </div>
  </nav>
