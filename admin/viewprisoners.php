...
<caption><h3>INMATES INFORMATION</h3></caption>
<tr bgcolor='green'>
...
echo  "<td width='5%'>".$row ['date_in']."</td>";
echo  "<td width='5%'>".$row ['date_out']."</td>";
echo  "<td width='10%'>".$row ['sentence_to']."</td>";
